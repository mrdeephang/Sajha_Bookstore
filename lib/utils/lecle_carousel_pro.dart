...
class Carousel extends StatefulWidget {
  /// All the images on this Carousel. Can be FadeInImage, ImageProvider or a list of widgets
  final List<dynamic>? images;

  /// The default images on this Carousel. It can be a widget or an ImageProvider
  ...
  const Carousel({
    ...
    this.onImageChange,
    this.defaultImage,
  })  : assert(images != null || defaultImage != null),
        super(key: key);
        ...
        Builder(
          builder: (_) {
            Widget pageView = PageView(
              ...
              onPageChanged: (currentPage) {
                if (widget.onImageChange != null) {
                  widget.onImageChange!.call(_currentImageIndex, currentPage);
                }
            ...
            return GestureDetector(
              child: pageView,
              onTap: () => widget.onImageTap?.call(_currentImageIndex),
            );
          },
        ),
