...
class booksdetails extends StatefulWidget {
  ...
  final book_pic;
  booksdetails({this.book_name,this.book_price,this.book_author,this.book_edition,this.book_condition,this.book_pic});
      ...
      body: ListView(
        children: [
          Container(
            ...
            child: GridTile(
              ...
              footer: Container(
                color: Colors.white,
                child: ListTile(
                  leading:Text(widget.book_name,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                  title: Row(
                    children: [
                      Expanded(
                        child:Text("\Rs.${widget.book_price}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
          ...
          Row(
            children: [
              Expanded(
                child: MaterialButton(onPressed: (){},color: Colors.deepPurple,textColor: Colors.black,
                elevation: 0.2,
                child: Row(
                  children: [
              ...
              Expanded(
                ...
                child: Row(
                  children: [
                    ...
                    Text("Rent",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
              ...
              Expanded(
                ...
                },color: Colors.deepPurple,textColor: Colors.black,
                elevation: 0.2,
                child: Row(
                  children: [
          ...
          Row(
           ...
           Row(
            children: [
              Padding(padding: EdgeInsets.fromLTRB(12, 5, 5, 5),
              child: Text('Condition:',style: TextStyle(color: Colors.grey),),
              ),
               Padding(padding: EdgeInsets.all(5),
           ...
           Row(
            children: [
              Padding(padding: EdgeInsets.fromLTRB(12, 5, 5, 5),
              child: Text('Edition:',style: TextStyle(color: Colors.grey),),
              ),
               Padding(padding: EdgeInsets.all(5),
           ...
           Row(
            children: [
              Padding(padding: EdgeInsets.fromLTRB(12, 5, 5, 5),
              child: Text('Publisher:',style: TextStyle(color: Colors.grey),),
              ),
               Padding(padding: EdgeInsets.all(5),
          ...
          Padding(
            ...
            child: Text('More Books',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
          ),
          Container(
            height: 360,
            child: similarbooks(),
